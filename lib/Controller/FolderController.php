...
class FolderController extends OCSController {
	...
	/**
	 * @param FolderWithMappings $folder
	 * @return GroupFoldersFolder
	 */
	private function formatFolder(FolderWithMappings $folder): array {
		return [
			'id' => $folder->id,
	...
	private function checkedGetFolder(int $id): FolderWithMappings {
