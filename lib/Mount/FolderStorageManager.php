...
class FolderStorageManager {
	 ...
	 */
	public function getBaseStorageForFolder(int $folderId, ?\OCA\GroupFolders\Folder\Folder $folder = null, ?IUser $user = null, bool $inShare = false, string $type = 'files'): IStorage {
		try {
