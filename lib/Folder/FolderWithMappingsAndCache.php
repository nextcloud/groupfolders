 ...
 */
class FolderWithMappingsAndCache extends FolderWithMappings {
	/**
	 ...
	 * @psalm-param list<GroupFoldersAclManage> $manage
	 */
	public static function fromFolderWithMapping(FolderWithMappings $folder, ICacheEntry $rootCacheEntry): FolderWithMappingsAndCache {
