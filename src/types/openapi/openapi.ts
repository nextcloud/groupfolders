...
export type paths = {
    "/ocs/v2.php/apps/groupfolders/delegation/groups": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/ocs/v2.php/apps/groupfolders/delegation/circles": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/ocs/v2.php/apps/groupfolders/delegation/authorized-groups": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/ocs/v2.php/apps/groupfolders/folders/{id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/ocs/v2.php/apps/groupfolders/folders/{id}/groups": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/ocs/v2.php/apps/groupfolders/folders/{id}/groups/{group}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/ocs/v2.php/apps/groupfolders/folders/{id}/manageACL": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/ocs/v2.php/apps/groupfolders/folders/{id}/quota": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/ocs/v2.php/apps/groupfolders/folders/{id}/acl": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/ocs/v2.php/apps/groupfolders/folders/{id}/mountpoint": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/ocs/v2.php/apps/groupfolders/folders/{id}/search": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
...
export interface operations {
    ...
    "delegation-get-authorized-groups": {
        parameters: {
            query?: {
                /** @description If the classname is - OCA\GroupFolders\Settings\Admin : It's reference to fields in Admin Priveleges. - OCA\GroupFolders\Controller\DelegationController : It's just to specific the subadmins. They can only manage groupfolders in which they are added in the Advanced Permissions (groups only) */
                classname?: string;
            };
            header: {
                /** @description Required to be true for the API request to pass */
    ...
    "folder-add-group": {
        ...
        responses: {
            /** @description Group access added sucessfully */
            200: {
                headers: {
                    [name: string]: unknown;
                };
