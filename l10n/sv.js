OC.L10N.register(
    ...
    "Team folders encryption" : "Kryptering av teammappar",
    "Encrypt team folders using server-side encryption. Remember that the data cannot be accessed if the encryption key is lost." : "Kryptera teammappar med kryptering på serversidan. Kom ihåg att det inte går att komma åt data om krypteringsnyckeln går förlorad.",
    "Enable Team Folders encryption" : "Aktivera kryptering av teammappar",
    "Disabling team folders encryption is only possible using OCC, please refer to the documentation." : "Kryptering av teammappar kan endast inaktiveras med OCC. Se dokumentationen.",
    "Team Folders encryption cannot be enabled on the server because server-side encryption is disabled." : "Kryptering av teammappar kan inte aktiveras eftersom kryptering på serversidan är inaktiverad.",
    ...
    "Team space" : "Teamutrymme",
    "Folder name" : "Mappnamn",
    "This team space belongs to a team and cannot be renamed" : "Det här teamutrymmet tillhör ett team och kan inte byta namn",
    "Rename \"{mountPoint}\"" : "Byt namn på ”{mountPoint}”",
    "Advanced permissions are managed by the team" : "Avancerade behörigheter hanteras av teamet",
    "Enabled" : "Aktiverad",
    ...
    "Advanced permissions for \"{mountPoint}\"" : "Avancerade behörigheter för ”{mountPoint}”",
    "This folder belongs to a team and cannot be deleted directly; unlink it from its team first" : "Den här mappen tillhör ett team och kan inte tas bort direkt; koppla först bort den från teamet.",
    "No Team spaces yet" : "Inga teamutrymmen ännu",
    "No Team folders or Team spaces yet" : "Inga teammappar eller teamutrymmen ännu",
    ...
    "Actions" : "Åtgärder",
    "Pagination of team folders and team spaces" : "Sidindelning för teammappar och teamutrymmen",
    "Previous" : "Föregående",
    "Next" : "Nästa",
    "Page:" : "Sida:",
    "User" : "Användare",
    ...
    "Assign groups" : "Tilldela grupper",
    "Edit assigned groups: {groups}" : "Redigera tilldelade grupper: {groups}",
    ...
    "Other …" : "Annat …",
    "sorted descending" : "sorterade fallande",
    "sorted ascending" : "sorterade stigande",
    "Admin configured folders shared with everyone in a team" : "Administratörskonfigurerade mappar som delas med alla i ett team",
    "Admin configured folders shared with everyone in a team.\n\nFolders can be configured from *Team folders* in the admin settings.\n\nAfter a folder is created, the admin can give access to the folder to one or more teams, control their write/sharing permissions and assign a quota for the folder.\nAs of Hub 10/Nextcloud 31, the admin needs to be a part of the team to be able to assign it a Team folder." : "Administratörskonfigurerade mappar som delas med alla i ett team.\n\nMappar kan konfigureras under *Teammappar* i administrationsinställningarna.\n\nNär en mapp har skapats kan administratören ge ett eller flera team åtkomst till den, styra deras skriv- och delningsbehörigheter samt tilldela mappen en kvot.\nFrån och med Hub 10/Nextcloud 31 måste administratören ingå i teamet för att kunna tilldela det en teammapp.",
