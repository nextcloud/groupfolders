OC.L10N.register(
    ...
    "Shared folders managed by admins, accessible to designated groups and teams with configurable permissions and quotas" : "Pastas compartilhadas gerenciadas por administradores, acessíveis a grupos e equipes designados, com permissões e cotas configuráveis",
    "The Group folders app allows administrators to create and manage shared folders for selected\ngroups and teams within Nextcloud.\n\nAdmins can grant one or more groups or teams access to a folder, configure permissions (such\nas read, write, and sharing rights), and assign storage quotas from the Group folders section (under\nadmin settings). The app also supports advanced permissions and integration with Nextcloud’s\ntrash and versioning systems.\n\nAs of Hub 10 / Nextcloud 31, admins must be members of a team to assign that team to a Team\nfolder." : "O aplicativo Pastas de grupo permite que os administradores criem e gerenciem pastas compartilhadas para\ngrupos e equipes selecionados no Nextcloud.\n\nOs administradores podem conceder acesso a uma pasta a um ou mais grupos ou equipes, configurar permissões (como\ndireitos de leitura, gravação e compartilhamento) e atribuir cotas de armazenamento na seção Pastas de grupo (em\nconfigurações de administração). O aplicativo também oferece suporte a permissões avançadas e integração com a\nlixeira e os sistemas de controle de versões do Nextcloud.\n\nA partir do Hub 10 / Nextcloud 31, os administradores devem ser membros de uma equipe para atribuir essa equipe a uma\npasta de equipe.",
    "Unset" : "Redefinir",
    ...
    "Advanced permissions for group folder" : "Permissões avançadas para a pasta de grupo",
    ...
    "Select a user or team" : "Selecione um usuário ou uma equipe",
    "Failed to update encryption setting" : "Falha ao atualizar a configuração de criptografia",
    "Group folders encryption" : "Criptografia de pastas de grupo",
    "Encrypt group folders using server-side encryption. Remember that the data cannot be accessed if the encryption key is lost." : "Criptografe pastas de grupo usando criptografia do lado do servidor. Lembre-se de que não será possível acessar os dados caso a chave de criptografia seja perdida.",
    "Enable group folders encryption" : "Ativar a criptografia de pastas de grupo",
    "Disabling group folders encryption is only possible using OCC, please refer to the documentation." : "A desativação da criptografia de pastas de grupo só é possível por meio do OCC; consulte a documentação.",
    "Group folders encryption cannot be enabled on the server because server-side encryption is disabled." : "A criptografia de pastas de grupo não pode ser ativada no servidor porque a criptografia do lado do servidor está desativada.",
    ...
    "This team folder belongs to a team and cannot be renamed" : "Esta pasta da equipe pertence a uma equipe e não pode ser renomeada",
    "Rename \"{mountPoint}\"" : "Renomear “{mountPoint}”",
    "Advanced permissions are managed by the team" : "As permissões avançadas são gerenciadas pela equipe",
    "Enabled" : "Ativadas",
    ...
    "Advanced permissions for \"{mountPoint}\"" : "Permissões avançadas para “{mountPoint}”",
    "This folder belongs to a team and cannot be deleted directly; unlink it from its team first" : "Esta pasta pertence a uma equipe e não pode ser excluída diretamente; primeiro, desvincule-a da equipe",
    "No team folders yet" : "Ainda não há pastas de equipe",
    "No group folders or team folders yet" : "Ainda não há pastas de grupo nem pastas de equipe",
    "Group folder name" : "Nome da pasta de grupo",
    ...
    "Actions" : "Ações",
    "Pagination of group folders and team folders" : "Paginação de pastas de grupo e pastas de equipe",
    "Previous" : "Anterior",
    "Next" : "Próxima",
    "Page:" : "Página:",
    "User" : "Usuário",
    ...
    "Assign groups" : "Atribuir grupos",
    "Edit assigned groups: {groups}" : "Editar grupos atribuídos: {groups}",
    ...
    "Open Team folder" : "Abrir a pasta de equipe",
    ...
    "List of Team folders." : "Lista das pastas de equipe.",
    "No Team folders yet" : "Ainda não há pastas de equipe",
