OC.L10N.register(
    ...
    "Team Folders (formerly \"Group Folders\") allows administrators to create and manage shared folders that are accessible \n\t\t\tto selected teams within Nextcloud.\n\n\t\t\tAdmins can configure folders from the Team Folders section in the admin settings, where they can grant access to one \n\t\t\tor more teams, set custom permissions (such as read, write, and sharing rights), and assign storage quotas to each \n\t\t\tfolder.\n\n\t\t\tAs of Hub 10/Nextcloud 31, admins must be members of a team to assign it a Team Folder. The app supports advanced \n\t\t\tfeatures such as quota management, granular access control, and integration with Nextcloud’s trash and versioning \n\t\t\tsystems." : "As Pastas de Equipe (anteriormente \"Pastas de Grupo\") permitem que os administradores criem e gerenciem pastas compartilhadas que são acessíveis\n\t\t\ta equipes selecionadas dentro do Nextcloud.\n\n\t\t\tOs administradores podem configurar pastas na seção Pastas de Equipe nas configurações de administração, onde podem conceder acesso a uma\n\t\t\tou mais equipes, definir permissões personalizadas (como direitos de leitura, gravação e compartilhamento) e atribuir cotas de armazenamento a cada\n\t\t\tpasta.\n\n\t\t\tA partir do Hub 10/Nextcloud 31, os administradores devem ser membros de uma equipe para atribuir uma Pasta de Equipe a ela. O aplicativo oferece suporte a recursos\n\t\t\tavançados, como gerenciamento de cotas, controle de acesso granular e integração com os sistemas de lixo eletrônico e controle de versão do\n\t\t\tNextcloud.",
    "Unset" : "Redefinir",
