OC.L10N.register(
    ...
    "Team folders encryption" : "Takım klasörleri şifrelemesi",
    "Encrypt team folders using server-side encryption. Remember that the data cannot be accessed if the encryption key is lost." : "Sunucu tarafı şifrelemeyi kullanarak takım klasörlerini şifreler. Şifreleme anahtarı kaybolursa verilere erişilemeyeceğini unutmayın.",
    "Enable Team Folders encryption" : "Takım klasörleri şifrelemesini aç",
    "Disabling team folders encryption is only possible using OCC, please refer to the documentation." : "Takım klasörleri şifrelemesini yalnızca OCC kullanılarak kapatılabilir. Lütfen belgelere bakın.",
    "Team Folders encryption cannot be enabled on the server because server-side encryption is disabled." : "Sunucu tarafı şifreleme kapatıldığı için takım klasörleri şifrelemesi sunucuda açılamadı.",
    ...
    "This team space belongs to a team and cannot be renamed" : "Bu takım alanı bir takıma aittir ve yeniden adlandırılamaz",
    ...
    "No Team spaces yet" : "Henüz bir takım alanı yok",
    "No Team folders or Team spaces yet" : "Henüz bir takım klasörü veya takım alanı yok",
    ...
    "Actions" : "İşlemler",
    "Pagination of team folders and team spaces" : "Takım klasörlerinin ve takım alanlarının sayfalaması",
    "Previous" : "Önceki",
    "Next" : "Sonraki",
    "Page:" : "Sayfa:",
    "User" : "Kullanıcı",
