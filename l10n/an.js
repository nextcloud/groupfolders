OC.L10N.register(
    ...
    "Admin configured folders shared with everyone in a group.\n\nFolders can be configured from *Group folders* in the admin settings.\n\nAfter a folder is created, the admin can give access to the folder to one or more groups, control their write/sharing permissions and assign a quota for the folder.\n\nNote: Encrypting the contents of group folders is currently not supported." : "Carpetas confeguradas por l'administrador y compartidas con toz os miembros d'un grupo.\n\nAs carpetas pueden configurar-se dende *Carpetas de grupo* en a configuración de l'administrador.\n\nDimpués de crear una carpeta, l'administrador puede dar acceso a la carpeta a un u más grupos, controlar os suyos permisos d'escritura/compartición y asignar una conduta ta la carpeta.\n\nNota: Actualment no se puede cifrar o conteniu d'as carpetas de grupo.",
