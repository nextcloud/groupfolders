OC.L10N.register(
    ...
    "Group" : "Grupo",
    "Team" : "Equipo",
    "Could not save changes. Please try again." : "No se pudieron guardar los cambios. Por favor, inténtelo de nuevo.",
    "Advanced permissions for Team folder" : "Permisos avanzados para la carpeta del equipo",
    "Group, team, or user" : "Grupo, equipo o usuario",
    "Read" : "Leer",
    "Write" : "Escribir",
    "Create" : "Crear",
    "Delete" : "Eliminar",
    ...
    "Inherited permission cannot be removed" : "El permiso heredado no se puede eliminar",
    "Add new rule" : "Añadir nueva regla",
    "Select a user or team" : "Selecciona un usuario o un equipo",
    ...
    "Unlimited" : "Ilimitado",
    "Folder could not be created" : "No se pudo crear la carpeta",
    ...
    "Folder could not be renamed" : "La carpeta no pudo ser renombrada",
    ...
    "Advanced permissions are only supported with Nextcloud 16 and up" : "Los permisos avanzados solo son compatibles con Nextcloud 16 y versiones posteriores"
},
