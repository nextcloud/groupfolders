OC.L10N.register(
    ...
    "Team Folders (formerly \"Group Folders\") allows administrators to create and manage shared folders that are accessible \n\t\t\tto selected teams within Nextcloud.\n\n\t\t\tAdmins can configure folders from the Team Folders section in the admin settings, where they can grant access to one \n\t\t\tor more teams, set custom permissions (such as read, write, and sharing rights), and assign storage quotas to each \n\t\t\tfolder.\n\n\t\t\tAs of Hub 10/Nextcloud 31, admins must be members of a team to assign it a Team Folder. The app supports advanced \n\t\t\tfeatures such as quota management, granular access control, and integration with Nextcloud’s trash and versioning \n\t\t\tsystems." : "Mit Teamordnern (früher „Gruppenordner“) können Administratoren freigegebene Ordner erstellen und verwalten, auf die ausgewählte Teams in Nextcloud zugreifen können.\n\nAdministratoren können Ordner im Bereich „Teamordner“ in den Administratoreinstellungen konfigurieren. Dort können sie einem oder mehreren Teams Zugriff gewähren, benutzerdefinierte Berechtigungen (wie Lese-, Schreib- und Freigaberechte) festlegen und jedem Ordner Speicherkontingente zuweisen.\n\nAb Hub 10/Nextcloud 31 müssen Administratoren Mitglied eines Teams sein, um diesem einen Teamordner zuweisen zu können. Die App unterstützt erweiterte Funktionen wie Kontingentverwaltung, granulare Zugriffskontrolle und die Integration mit den Papierkorb- und Versionsverwaltungssystemen von Nextcloud.",
    "Unset" : "Entfernt",
