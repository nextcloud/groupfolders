OC.L10N.register(
    ...
    "They will only have access to Groupfolders for which they have advanced permissions." : "Они будут иметь доступ только к тем групповым папкам, для которых у них есть повышенные привилегии.",
    "Groups" : "Группы"
},
