OC.L10N.register(
    ...
    "Open Team folder" : "Открыть Общую папку",
    ...
    "List of Team folders." : "Список Общих папок.",
    "No Team folders yet" : "Пока нет Общих папок",
    "Team folders will show up here" : "Здесь будут отображаться Общие папки",
    ...
    "Team folder admin delegation" : "Делегирование полномочий администратора Общей папки",
    "They will have access to all Team folders." : "Они будут иметь доступ ко всем Общим папкам.",
    "They will only have access to Team folders for which they have advanced permissions." : "Они будут иметь доступ только к тем Общим папкам, для которых у них есть расширенные права.",
