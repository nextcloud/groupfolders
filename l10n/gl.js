OC.L10N.register(
    ...
    "Admin configured folders shared with everyone in a group.\n\nFolders can be configured from *Group folders* in the admin settings.\n\nAfter a folder is created, the admin can give access to the folder to one or more groups, control their write/sharing permissions and assign a quota for the folder.\n\nNote: Encrypting the contents of group folders is currently not supported." : "Os cartafoles configurados polo administrador son compartidos con todos os membros dun grupo.\n\nOs cartafoles pódense configurar desde *Cartafoles de grupo* na configuración do administrador.\n\nDespois de crear un cartafol, o administrador pode dar acceso ao cartafol a un ou máis grupos, controlar os seus permisos de escritura/compartimento e asignar unha cota para o cartafol.\n\nNota: actualmente non se admite cifrar o contido dos cartafoles do grupo.",
    "Denied" : "Denegado",
