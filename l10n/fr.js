OC.L10N.register(
    ...
    "Deny" : "Refuser",
    "Allow" : "Autoriser",
    "Group folder" : "Dossiers de groupe",
    "Read" : "Lire",
    "Write" : "Écrire",
    "Create" : "Créer",
    "Delete" : "Supprimer",
    ...
    "Group folder admin delegation": "Délégation admin des Dossiers de groupe",
    "Nextcloud allows you to delegate the administration of groupfolders to non-admin users.": "Nextcloud vous permet de déléguer l'administration des dossiers de groupe à des utilisateurs non administrateur de Nextcloud.",
    "Specify below the groups that will be allowed to manage groupfolders and use its API/REST.": "Spécifier ci-dessous les groupes qui seront autorisés à gérer les dossiers de groupe et à utiliser ses API/REST.",
    "They will have access to all Groupfolders.": "Ils auront accès à tous les dossiers de groupe.",
    "Specify below the groups that will be allowed to manage groupfolders and use its API/REST only.": "Spécifier ci-dessous les groupes qui seront autorisés à gérer les dossiers de groupe et à utiliser ses API/REST uniquement.",
    "They will only have access to Groupfolders for which they have advanced permissions.": "Ils n'auront accès qu'aux dossiers de groupe dont ils gèrent les autorisations avancées.",
