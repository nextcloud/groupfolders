OC.L10N.register(
    ...
    "Team Folders (formerly \"Group Folders\") allows administrators to create and manage shared folders that are accessible \n\t\t\tto selected teams within Nextcloud.\n\n\t\t\tAdmins can configure folders from the Team Folders section in the admin settings, where they can grant access to one \n\t\t\tor more teams, set custom permissions (such as read, write, and sharing rights), and assign storage quotas to each \n\t\t\tfolder.\n\n\t\t\tAs of Hub 10/Nextcloud 31, admins must be members of a team to assign it a Team Folder. The app supports advanced \n\t\t\tfeatures such as quota management, granular access control, and integration with Nextcloud’s trash and versioning \n\t\t\tsystems." : "Les dossiers d'équipe (anciennement « dossiers de groupe ») permettent aux administrateurs de créer et de gérer des dossiers partagés accessibles \n\t\t\tà certaines équipes au sein de Nextcloud.\n\n\t\t\tLes administrateurs peuvent configurer les dossiers dans la section Dossiers d'équipe des paramètres d'administration, où ils peuvent accorder l'accès à une \n\t\t\tou plusieurs équipes, définir des autorisations personnalisées (telles que les droits de lecture, d'écriture et de partage) et attribuer des quotas de stockage à chaque \n\t\t\tdossier.\n\n\t\t\tÀ partir de Hub 10/Nextcloud 31, les administrateurs doivent être membres d'une équipe pour lui attribuer un dossier d'équipe. L'application prend en charge des\n \t\t\tfonctionnalités avancées telles que la gestion des quotas, le contrôle d'accès granulaire et l'intégration avec les\n \t\t\tsystèmes de corbeille et de gestion des versions de Nextcloud\n.",
    "Unset" : "Désactiver",
