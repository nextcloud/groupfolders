OC.L10N.register(
    ...
    "Advanced permissions for group folder" : "Advanced permissions for group folder",
    "Group, team, or user" : "Group, team, or user",
    "Read" : "Read",
    "Write" : "Write",
    "Create" : "Create",
    "Delete" : "Delete",
    ...
    "Inherited permission cannot be removed" : "Inherited permission cannot be removed",
    "Add new rule" : "Add new rule",
    "Select a user or team" : "Select a user or team",
    "Failed to update encryption setting" : "Failed to update encryption setting",
    "Group folders encryption" : "Group folders encryption",
    "Encrypt group folders using server-side encryption. Remember that the data cannot be accessed if the encryption key is lost." : "Encrypt group folders using server-side encryption. Remember that the data cannot be accessed if the encryption key is lost.",
    "Enable group folders encryption" : "Enable group folders encryption",
    "Disabling group folders encryption is only possible using OCC, please refer to the documentation." : "Disabling group folders encryption is only possible using OCC, please refer to the documentation.",
    "Group folders encryption cannot be enabled on the server because server-side encryption is disabled." : "Group folders encryption cannot be enabled on the server because server-side encryption is disabled.",
    ...
    "Default" : "Default",
    "Unlimited" : "Unlimited",
    "Folder could not be created" : "Folder could not be created",
    ...
    "Folder could not be renamed" : "Folder could not be renamed",
    ...
    "This team folder belongs to a team and cannot be renamed" : "This team folder belongs to a team and cannot be renamed",
    "Rename \"{mountPoint}\"" : "Rename \"{mountPoint}\"",
    "Advanced permissions are managed by the team" : "Advanced permissions are managed by the team",
    "Enabled" : "Enabled",
    "Disabled" : "Disabled",
    ...
    "Advanced permissions for \"{mountPoint}\"" : "Advanced permissions for \"{mountPoint}\"",
    "This folder belongs to a team and cannot be deleted directly; unlink it from its team first" : "This folder belongs to a team and cannot be deleted directly; unlink it from its team first",
    "No team folders yet" : "No team folders yet",
    "No group folders or team folders yet" : "No group folders or team folders yet",
    "Group folder name" : "Group folder name",
    ...
    "Actions" : "Actions",
    "Pagination of group folders and team folders" : "Pagination of group folders and team folders",
    "Previous" : "Previous",
    "Next" : "Next",
    "Page:" : "Page:",
    "User" : "User",
    ...
    "Admin configured folders shared with everyone in a team.\n\nFolders can be configured from *Team folders* in the admin settings.\n\nAfter a folder is created, the admin can give access to the folder to one or more teams, control their write/sharing permissions and assign a quota for the folder.\nAs of Hub 10/Nextcloud 31, the admin needs to be a part of the team to be able to assign it a Team folder." : "Admin configured folders shared with everyone in a team.\n\nFolders can be configured from *Team folders* in the admin settings.\n\nAfter a folder is created, the admin can give access to the folder to one or more teams, control their write/sharing permissions and assign a quota for the folder.\nAs of Hub 10/Nextcloud 31, the admin needs to be a part of the team to be able to assign it a Team folder.",
