OC.L10N.register(
    ...
    "Advanced permissions for Team folder" : "チームフォルダに対する高度なアクセス権限",
    ...
    "Disabling team folders encryption is only possible using OCC, please refer to the documentation." : "チームフォルダの暗号化を無効にするには、OCCを使用する必要があります。詳細については、ドキュメントをご参照ください。",
