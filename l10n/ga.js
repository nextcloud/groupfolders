OC.L10N.register(
    ...
    "Team Folders (formerly \"Group Folders\") allows administrators to create and manage shared folders that are accessible \n\t\t\tto selected teams within Nextcloud.\n\n\t\t\tAdmins can configure folders from the Team Folders section in the admin settings, where they can grant access to one \n\t\t\tor more teams, set custom permissions (such as read, write, and sharing rights), and assign storage quotas to each \n\t\t\tfolder.\n\n\t\t\tAs of Hub 10/Nextcloud 31, admins must be members of a team to assign it a Team Folder. The app supports advanced \n\t\t\tfeatures such as quota management, granular access control, and integration with Nextcloud’s trash and versioning \n\t\t\tsystems." : "Le Fillteáin Foirne (ar a dtugtaí \"Fillteáin Ghrúpa\" roimhe seo) is féidir le riarthóirí fillteáin chomhroinnte a chruthú agus a bhainistiú atá inrochtana\n\t\t\tag foirne roghnaithe laistigh de Nextcloud.\n\nIs féidir le riarthóirí fillteáin a chumrú ón rannán Fillteáin Foirne sna socruithe riaracháin, áit ar féidir leo rochtain a dheonú ar fhoireann amháin\n\t\t\tnó níos mó, ceadanna saincheaptha a shocrú (amhail cearta léite, scríbhneoireachta agus comhroinnte), agus cuótaí stórála a shannadh do gach\n\t\t\tfillteán.\n\nÓ Hub 10/Nextcloud 31, ní mór do riarthóirí a bheith ina mbaill d'fhoireann chun Fillteán Foirne a shannadh di. Tacaíonn an aip le gnéithe\n\t\t\tardleibhéil amhail bainistíocht cuótaí, rialú rochtana mionsonraithe, agus comhtháthú le córais\n\t\t\tbhosca bruscair agus leaganacha Nextcloud.",
    "Unset" : "Díshocraithe",
