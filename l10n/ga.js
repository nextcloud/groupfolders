OC.L10N.register(
    ...
    "Team folders encryption" : "Criptiú fillteán foirne",
    "Encrypt team folders using server-side encryption. Remember that the data cannot be accessed if the encryption key is lost." : "Criptigh fillteáin foirne ag baint úsáide as criptiú taobh an fhreastalaí. Cuimhnigh nach féidir rochtain a fháil ar na sonraí má chailltear an eochair chriptithe.",
    "Enable Team Folders encryption" : "Cumasaigh criptiú Fillteán Foirne",
    "Disabling team folders encryption is only possible using OCC, please refer to the documentation." : "Ní féidir criptiú fillteán foirne a dhíchumasú ach amháin trí OCC a úsáid, féach ar an doiciméadú le do thoil.",
    "Team Folders encryption cannot be enabled on the server because server-side encryption is disabled." : "Ní féidir criptiú Fillteán Foirne a chumasú ar an bhfreastalaí mar go bhfuil criptiú taobh an fhreastalaí díchumasaithe.",
    ...
    "This team space belongs to a team and cannot be renamed" : "Is le foireann an spás foirne seo agus ní féidir é a athainmniú",
    ...
    "No Team spaces yet" : "Gan aon spásanna Foirne fós",
    "No Team folders or Team spaces yet" : "Gan aon fhillteáin foirne ná spásanna foirne go fóill",
    ...
    "Actions" : "Gníomhartha",
    "Pagination of team folders and team spaces" : "Leathanachú fillteán foirne agus spásanna foirne",
    "Previous" : "Roimhe Seo",
    "Next" : "Ar aghaidh",
    "Page:" : "Leathanach:",
    "User" : "Úsáideoir",
