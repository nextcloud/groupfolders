OC.L10N.register(
    ...
    "Team Folders (formerly \"Group Folders\") allows administrators to create and manage shared folders that are accessible \n\t\t\tto selected teams within Nextcloud.\n\n\t\t\tAdmins can configure folders from the Team Folders section in the admin settings, where they can grant access to one \n\t\t\tor more teams, set custom permissions (such as read, write, and sharing rights), and assign storage quotas to each \n\t\t\tfolder.\n\n\t\t\tAs of Hub 10/Nextcloud 31, admins must be members of a team to assign it a Team Folder. The app supports advanced \n\t\t\tfeatures such as quota management, granular access control, and integration with Nextcloud’s trash and versioning \n\t\t\tsystems." : "Фолдери тима (раније „Фолдери групе”) омогућавају администраторима да крреирају и управљају дељеним фолдерима који су доступни \n\t\t\tодређеним тимовима унутар Nextcloud.\n\n\t\t\tАдмини могу да подесе фолдере из одељка Фолдери тима у админ подешавањима, тамо могу да одобре приступ једном \n\t\t\tили више тимова, поставе произвољне дозволе (као што су права читања, уписа и дељења) и да доделе квоте складишта\n\t\t\tсваком фолдеру.\n\n\t\t\tПочевши од Hub 10/Nextcloud 31, админи морају да буду чланови тима да би могли да му доделе Фолдер тима. Апликација подржава\n\t\t\tнапредне могућности као што су управљање квотом, слојевита контрола приступа, и интеграција са Nextcloud системима за отпад и\n\t\t\tи чување верзија.",
    "Unset" : "Уклони",
