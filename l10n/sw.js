OC.L10N.register(
    ...
    "Team Folders (formerly \"Group Folders\") allows administrators to create and manage shared folders that are accessible \n\t\t\tto selected teams within Nextcloud.\n\n\t\t\tAdmins can configure folders from the Team Folders section in the admin settings, where they can grant access to one \n\t\t\tor more teams, set custom permissions (such as read, write, and sharing rights), and assign storage quotas to each \n\t\t\tfolder.\n\n\t\t\tAs of Hub 10/Nextcloud 31, admins must be members of a team to assign it a Team Folder. The app supports advanced \n\t\t\tfeatures such as quota management, granular access control, and integration with Nextcloud’s trash and versioning \n\t\t\tsystems." : "Folda za Timu (zamani \"Folda za Kikundi\") huruhusu wasimamizi kuunda na kudhibiti folda zinazoshirikiwa ambazo zinaweza kufikiwa. \n\t\t\tkwa timu ulizochagua ndani ya Nextcloud.\n\n\t\t\tWasimamizi wanaweza kusanidi folda kutoka sehemu ya Folda za Timu katika mipangilio ya msimamizi, ambapo wanaweza kutoa ufikiaji kwa moja. \n\t\t\tau timu zaidi, weka ruhusa maalum (kama vile kusoma, kuandika na kushiriki haki za kushiriki), na gawa sehemu za hifadhi kwa kila mmoja. \n\t\t\tfolda.\n\n\t\t\tKuanzia Hub 10/Nextcloud 31, wasimamizi lazima wawe washiriki wa timu ili kuikabidhi Folda ya Timu. Programu inasaidia hali ya juu \n\t\t\tvipengele kama vile udhibiti wa kiasi, udhibiti wa ufikiaji wa punjepunje, na ujumuishaji na tupio la Nextcloud na uchapishaji \n\t\t\tmifumo.",
    "Unset" : "Haijawekwa",
